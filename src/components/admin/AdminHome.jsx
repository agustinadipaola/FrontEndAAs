...
function UserHome() {
  return (
    <div style={{
      ...
      <h1> <span style={{ backgroundColor: "whitesmoke", marginTop: "10vh", padding: "20px", width:'100%', display:'block', borderRadius:'50px'}}>WELCOME BACK ADMIN  &nbsp; <MdWavingHand /></span></h1>
